...
const Generate = ({ text, setText, startDestination, endDestination, startDate, endDate }) => {
    ...
    return (<div className='bg-[#F3F4F6] '>
        {isMobile?<><div className='h-max w-full flex flex-col justify-center items-center  '><img src={img} className='h-64 w-full sm:w-full sm:h-full  ' alt={endDestination}/>
        ...
        <div className=' cardscontainer  h-full flex flex-col mx-4 sm:mx-8 '>
        {text.map((day, index) => {
